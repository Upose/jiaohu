...
<head>
    ...
    <link rel="stylesheet" href="/ProjectDelivery-master-4813cb78043ea21dbdcdbe7580c4f61a014acdb6/web/Public/Doc/css/login.css">
</head>
...
<body>
    ...
    <div class="con">
        <!-- 左边背景图 -->
        <img src="/ProjectDelivery-master-4813cb78043ea21dbdcdbe7580c4f61a014acdb6/web/Public/Doc/images/ct.png" alt="">
        <!-- 右边输入内容 -->
        <div class="login">
            <form>
                <img src="/ProjectDelivery-master-4813cb78043ea21dbdcdbe7580c4f61a014acdb6/web/Public/Doc/images/logo.png" alt="">
                <p>账号</p>
