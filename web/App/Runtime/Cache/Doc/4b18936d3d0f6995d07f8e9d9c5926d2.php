...
<head>
    ...
    <link rel="stylesheet" href="/ProjectDelivery/web/Public/Doc/css/login.css">
</head>
...
<body>
    ...
    <div class="con">
        <!-- 左边背景图 -->
        <img src="/ProjectDelivery/web/Public/Doc/images/ct.png" alt="">
        <!-- 右边输入内容 -->
        <div class="login">
            <form>
                <img src="/ProjectDelivery/web/Public/Doc/images/logo.png" alt="">
                <p>账号</p>
