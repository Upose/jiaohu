...
<body class="">
    <div id="app">
        <form action="<?php echo U('Feedback/FeedbackSubmit');?>" method="POST" enctype="multipart/form-data">
            <!-- <button @click="return()" type="button" class="layui-btn layui-btn-primary"><i class="layui-icon">&#xe65c;</i>
                返回</button> -->
            ...
            <div class="form_div2">
                ...
                <textarea name="describe" id="" v-model="message.des" cols="40" rows="5" required></textarea>
            </div>
            <div class="form_div2" style="vertical-align: top;">
                <label class="tit">原型截图</label>
                <div class="cus-files" id="cus-form">
                    ...
                    <div class="cus-files-content">
                        <div class="cus-warning">
                            <img class="img1" src="/Public/Doc/images/up@2x.png">
